...
export namespace tg {
    ...
    export async function sendSticker(
        ...
        return await callApi(env, 'sendSticker', {
            chat_id,
    ...
    export async function getStickerSet(
        ...
        return await callApi(env, 'getStickerSet', {
            name,
        });
    }
    ...
    export async function getCustomEmojiStickers(
        ...
        return await callApi(env, 'getCustomEmojiStickers', {
    ...
    export async function uploadStickerFile(
        ...
        return await callApi(env, 'uploadStickerFile', {
            user_id,
            sticker: JSON.stringify(sticker),
            sticker_format,
        });
    ...
    export async function createNewStickerSet(
        ...
        return await callApi(env, 'createNewStickerSet', {
            user_id,
            name,
            title,
    ...
    export async function addStickerToSet(
        ...
        return await callApi(env, 'addStickerToSet', {
            user_id,
            name,
            sticker: JSON.stringify(sticker),
        });
    ...
    export async function setStickerPositionInSet(
        ...
        return await callApi(env, 'setStickerPositionInSet', {
            sticker,
            position,
        });
    }
    ...
    export async function deleteStickerFromSet(
        ...
        return await callApi(env, 'deleteStickerFromSet', {
            sticker,
        });
    }
    ...
    export async function replaceStickerInSet(
        ...
        return await callApi(env, 'replaceStickerInSet', {
            user_id,
            name,
            old_sticker,
            sticker: JSON.stringify(sticker),
    ...
    export async function setStickerEmojiList(
        ...
        return await callApi(env, 'setStickerEmojiList', {
            sticker,
    ...
    export async function setStickerKeywords(
        ...
        return await callApi(env, 'setStickerKeywords', {
            sticker,
    ...
    export async function setStickerMaskPosition(
        ...
        return await callApi(env, 'setStickerMaskPosition', {
            sticker,
    ...
    export async function setStickerSetTitle(
        ...
        return await callApi(env, 'setStickerSetTitle', {
            name,
            title,
        });
    }
    ...
    export async function setStickerSetThumbnail(
        ...
        return await callApi(env, 'setStickerSetThumbnail', {
            name,
            user_id,
            format,
    ...
    export async function setCustomEmojiStickerSetThumbnail(
        ...
        return await callApi(env, 'setCustomEmojiStickerSetThumbnail', {
            name,
            custom_emoji_id,
        });
    }
    ...
    export async function deleteStickerSet(
        ...
        return await callApi(env, 'deleteStickerSet', {
            name,
        });
    }
}
