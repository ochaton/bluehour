...
export namespace tg {
    ...
    export async function sendInvoice(
        ...
        return await callApi(env, 'sendInvoice', {
            chat_id,
            title,
            description,
            payload,
    ...
    export async function createInvoiceLink(
        ...
        return await callApi(env, 'createInvoiceLink', {
            title,
            description,
            payload,
            currency,
    ...
    export async function answerShippingQuery(
        ...
        return await callApi(env, 'answerShippingQuery', {
            shipping_query_id,
            ok,
    ...
    export async function answerPreCheckoutQuery(
        ...
        return await callApi(env, 'answerPreCheckoutQuery', {
            pre_checkout_query_id,
            ok,
            error_message,
        });
    ...
    export async function getStarTransactions(
        ...
        return await callApi(env, 'getStarTransactions', {
            offset,
            limit,
        });
    }
    ...
    export async function refundStarPayment(
        ...
        return await callApi(env, 'refundStarPayment', {
            user_id,
            telegram_payment_charge_id,
        });
    }
