...
export namespace tg {
    ...
    export async function getUpdates(
        ...
        return await callApi(env, 'getUpdates', {
            offset,
            limit,
            timeout,
    ...
    export async function setWebhook(
        ...
        return await callApi(env, 'setWebhook', {
            url,
    ...
    export async function deleteWebhook(
        ...
        return await callApi(env, 'deleteWebhook', {
            drop_pending_updates,
        });
    }
     ...
     */
    export async function getWebhookInfo(env: Env): Promise<tgTypes.WebhookInfo> {
        return await callApi(env, 'getWebhookInfo');
    }
}
