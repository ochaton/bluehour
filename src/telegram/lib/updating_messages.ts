...
export namespace tg {
    ...
    export async function editMessageText(
        ...
        return await callApi(env, 'editMessageText', {
            text,
            business_connection_id,
            chat_id,
            message_id,
    ...
    export async function editMessageCaption(
        ...
        return await callApi(env, 'editMessageCaption', {
            business_connection_id,
            chat_id,
            message_id,
            inline_message_id,
    ...
    export async function editMessageMedia(
        ...
        return await callApi(env, 'editMessageMedia', {
    ...
    export async function editMessageLiveLocation(
        ...
        return await callApi(env, 'editMessageLiveLocation', {
            latitude,
            longitude,
            business_connection_id,
            chat_id,
    ...
    export async function stopMessageLiveLocation(
        ...
        return await callApi(env, 'stopMessageLiveLocation', {
            business_connection_id,
            chat_id,
            message_id,
            inline_message_id,
    ...
    export async function editMessageReplyMarkup(
        ...
        return await callApi(env, 'editMessageReplyMarkup', {
            business_connection_id,
            chat_id,
            message_id,
            inline_message_id,
    ...
    export async function stopPoll(
        ...
        return await callApi(env, 'stopPoll', {
            chat_id,
            message_id,
            business_connection_id,
            reply_markup: JSON.stringify(reply_markup),
    ...
    export async function deleteMessage(
        ...
        return await callApi(env, 'deleteMessage', {
            chat_id,
            message_id,
        });
    }
    ...
    export async function deleteMessages(
        ...
        return await callApi(env, 'deleteMessages', {
            chat_id,
